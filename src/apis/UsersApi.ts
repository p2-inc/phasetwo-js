...
export class UsersApi extends runtime.BaseAPI {
    ...
    async createMagicLinkRaw(requestParameters: CreateMagicLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling createMagicLink.');
        }

        if (requestParameters.magicLinkRepresentation === null || requestParameters.magicLinkRepresentation === undefined) {
            throw new runtime.RequiredError('magicLinkRepresentation','Required parameter requestParameters.magicLinkRepresentation was null or undefined when calling createMagicLink.');
        }
    ...
    async realmUsersUserIdOrgsOrgIdRolesGetRaw(requestParameters: RealmUsersUserIdOrgsOrgIdRolesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<OrganizationRoleRepresentation>>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling realmUsersUserIdOrgsOrgIdRolesGet.');
        }

        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling realmUsersUserIdOrgsOrgIdRolesGet.');
        }

        if (requestParameters.orgId === null || requestParameters.orgId === undefined) {
            throw new runtime.RequiredError('orgId','Required parameter requestParameters.orgId was null or undefined when calling realmUsersUserIdOrgsOrgIdRolesGet.');
        }
