...
export class EventsApi extends runtime.BaseAPI {
    ...
    async createEventRaw(requestParameters: CreateEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling createEvent.');
        }

        if (requestParameters.eventRepresentation === null || requestParameters.eventRepresentation === undefined) {
            throw new runtime.RequiredError('eventRepresentation','Required parameter requestParameters.eventRepresentation was null or undefined when calling createEvent.');
        }
    ...
    async createWebhookRaw(requestParameters: CreateWebhookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling createWebhook.');
        }

        if (requestParameters.webhookRepresentation === null || requestParameters.webhookRepresentation === undefined) {
            throw new runtime.RequiredError('webhookRepresentation','Required parameter requestParameters.webhookRepresentation was null or undefined when calling createWebhook.');
        }
    ...
    async deleteWebhookRaw(requestParameters: DeleteWebhookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling deleteWebhook.');
        }
    ...
    async getWebhookByIdRaw(requestParameters: GetWebhookByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookRepresentation>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling getWebhookById.');
        }
    ...
    async getWebhooksRaw(requestParameters: GetWebhooksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<WebhookRepresentation>>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling getWebhooks.');
        }
    ...
    async updateWebhookRaw(requestParameters: UpdateWebhookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling updateWebhook.');
        }
        ...
        if (requestParameters.webhookRepresentation === null || requestParameters.webhookRepresentation === undefined) {
            throw new runtime.RequiredError('webhookRepresentation','Required parameter requestParameters.webhookRepresentation was null or undefined when calling updateWebhook.');
        }
