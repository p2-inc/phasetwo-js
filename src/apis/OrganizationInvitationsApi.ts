...
export class OrganizationInvitationsApi extends runtime.BaseAPI {
    ...
    async addOrganizationInvitationRaw(requestParameters: AddOrganizationInvitationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling addOrganizationInvitation.');
        }

        if (requestParameters.orgId === null || requestParameters.orgId === undefined) {
            throw new runtime.RequiredError('orgId','Required parameter requestParameters.orgId was null or undefined when calling addOrganizationInvitation.');
        }

        if (requestParameters.invitationRequestRepresentation === null || requestParameters.invitationRequestRepresentation === undefined) {
            throw new runtime.RequiredError('invitationRequestRepresentation','Required parameter requestParameters.invitationRequestRepresentation was null or undefined when calling addOrganizationInvitation.');
        }
    ...
    async getOrganizationInvitationsRaw(requestParameters: GetOrganizationInvitationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<InvitationRepresentation>>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling getOrganizationInvitations.');
        }

        if (requestParameters.orgId === null || requestParameters.orgId === undefined) {
            throw new runtime.RequiredError('orgId','Required parameter requestParameters.orgId was null or undefined when calling getOrganizationInvitations.');
        }
    ...
    async removeOrganizationInvitationRaw(requestParameters: RemoveOrganizationInvitationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realm === null || requestParameters.realm === undefined) {
            throw new runtime.RequiredError('realm','Required parameter requestParameters.realm was null or undefined when calling removeOrganizationInvitation.');
        }

        if (requestParameters.orgId === null || requestParameters.orgId === undefined) {
            throw new runtime.RequiredError('orgId','Required parameter requestParameters.orgId was null or undefined when calling removeOrganizationInvitation.');
        }

        if (requestParameters.invitationId === null || requestParameters.invitationId === undefined) {
            throw new runtime.RequiredError('invitationId','Required parameter requestParameters.invitationId was null or undefined when calling removeOrganizationInvitation.');
        }
